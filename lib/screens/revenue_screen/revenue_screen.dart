...
//                       AppText(
//                           text:
//                               '''₹${BlocProvider.of<RevenueBloc>(context).state.balanceAmount.toString()}''',
//                           size: 0.06,
//                           fontFamily: AppFonts.normalText),
//                     ],
//                   ),
            ...
            return ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                context.read<RevenueBloc>().add(
                      TotalRevenue(amount: bookingDetail[Referencekeys.money]),
                    );
                return Revenue_transition_card(bookingDetail: bookingDetail);
              },
              separatorBuilder: (context, index) {
                return CustomSizedBoxHeight(0.02);
              },
            );
          }
        },
